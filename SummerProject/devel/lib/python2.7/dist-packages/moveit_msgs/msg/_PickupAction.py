...
"""
    ...
    try:
      ...
      for val1 in self.action_result.result.trajectory_start.attached_collision_objects:
        ...
        for val3 in _v94.plane_poses:
          ...
          _x = _v103
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v94.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
      ...
      for val1 in self.action_result.result.trajectory_stages:
        ...
        _v109 = _v108.header
        buff.write(_get_struct_I().pack(_v109.seq))
        _v110 = _v109.stamp
        _x = _v110
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v109.frame_id
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.action_goal.goal.path_constraints.orientation_constraints:
        _v284 = val1.header
        buff.write(_get_struct_I().pack(_v284.seq))
        _v285 = _v284.stamp
        _x = _v285
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v284.frame_id
      ...
      for val1 in self.action_goal.goal.path_constraints.visibility_constraints:
        ...
        _v294 = _v293.header
        buff.write(_get_struct_I().pack(_v294.seq))
        _v295 = _v294.stamp
        _x = _v295
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v294.frame_id
      ...
      for val1 in self.action_goal.goal.planning_options.planning_scene_diff.robot_state.attached_collision_objects:
        ...
        for val3 in _v305.plane_poses:
          ...
          _x = _v314
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v305.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
      ...
      for val1 in self.action_goal.goal.planning_options.planning_scene_diff.world.collision_objects:
        _v325 = val1.header
        buff.write(_get_struct_I().pack(_v325.seq))
        _v326 = _v325.stamp
        _x = _v326
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v325.frame_id
      ...
      for val1 in self.action_result.result.trajectory_start.attached_collision_objects:
        ...
        for val3 in _v340.plane_poses:
          ...
          _x = _v349
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v340.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
        ...
        _v351 = _v350.header
        buff.write(_get_struct_I().pack(_v351.seq))
        _v352 = _v351.stamp
        _x = _v352
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v351.frame_id
      ...
      for val1 in self.action_result.result.trajectory_stages:
        ...
        _v355 = _v354.header
        buff.write(_get_struct_I().pack(_v355.seq))
        _v356 = _v355.stamp
        _x = _v356
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v355.frame_id
