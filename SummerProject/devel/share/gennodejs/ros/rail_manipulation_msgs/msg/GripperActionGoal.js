...
class GripperActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GripperGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GripperActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = GripperGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new GripperGoal()
    }
...
module.exports = GripperActionGoal;
