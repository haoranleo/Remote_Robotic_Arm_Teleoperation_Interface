...
"""autogenerated by genpy from pr2_mechanism_msgs/ControllerStatistics.msg. Do not edit."""
import sys
...
class ControllerStatistics(genpy.Message):
  _md5sum = "6d15d137eea402018e3c7c8dbecd4b95"
  _type = "pr2_mechanism_msgs/ControllerStatistics"
...
time time_last_control_loop_overrun"""
  __slots__ = ['name','timestamp','running','max_time','mean_time','variance_time','num_control_loop_overruns','time_last_control_loop_overrun']
  _slot_types = ['string','time','bool','duration','duration','duration','int32','time']
