...
"""autogenerated by genpy from agile_grasp_base/CloudSized.msg. Do not edit."""
import sys
...
class CloudSized(genpy.Message):
  _md5sum = "4250ffa867aa297b69ecf90acee4dc17"
  _type = "agile_grasp_base/CloudSized"
...
MSG: std_msgs/Int64
int64 data"""
  __slots__ = ['cloud','size_left']
  _slot_types = ['sensor_msgs/PointCloud2','std_msgs/Int64']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_Bq().pack(_x.cloud.is_dense, _x.size_left.data))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.cloud.is_dense, _x.size_left.data,) = _get_struct_Bq().unpack(str[start:end])
