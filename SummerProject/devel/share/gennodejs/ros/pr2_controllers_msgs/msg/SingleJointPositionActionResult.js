...
class SingleJointPositionActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SingleJointPositionResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SingleJointPositionActionResult(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [status]
    data.status = actionlib_msgs.msg.GoalStatus.deserialize(buffer, bufferOffset);
    // Deserialize message field [result]
    data.result = SingleJointPositionResult.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SingleJointPositionActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = SingleJointPositionResult.Resolve(msg.result)
    }
    else {
      resolved.result = new SingleJointPositionResult()
    }
...
module.exports = SingleJointPositionActionResult;
