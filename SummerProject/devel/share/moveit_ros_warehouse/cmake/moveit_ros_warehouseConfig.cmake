...
if("TRUE" STREQUAL "TRUE")
  set(moveit_ros_warehouse_SOURCE_PREFIX /home/orsteam/SummerProject/src/moveit_ros/warehouse)
  set(moveit_ros_warehouse_DEVEL_PREFIX /home/orsteam/SummerProject/devel)
  ...
  set(moveit_ros_warehouse_INSTALL_PREFIX /home/orsteam/SummerProject/install)
...
if(NOT "/home/orsteam/SummerProject/src/moveit_ros/warehouse/warehouse/include " STREQUAL " ")
  set(moveit_ros_warehouse_INCLUDE_DIRS "")
  set(_include_dirs "/home/orsteam/SummerProject/src/moveit_ros/warehouse/warehouse/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'moveit_ros_warehouse' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'moveit_ros_warehouse' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/orsteam/SummerProject/src/moveit_ros/warehouse/${idir}'.  Ask the maintainer 'Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
