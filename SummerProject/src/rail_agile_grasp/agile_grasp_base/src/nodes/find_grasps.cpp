...
//typedef boost::shared_ptr<const rail_agile_grasp_msgs::FindGraspsGoal> Grasp_ptr;
...
int main(int argc, char** argv)
{
  ...
  //loc.findGrasps();
//const rail_agile_grasp_msgs::FindGraspsGoal *ptr=new const rail_agile_grasp_msgs::FindGraspsGoal
// Grasp_ptr goal(ptr);
 //rail_agile_grasp_msgs::FindGraspsGoal::ConstPtr findGraspsGoal;
 //loc.executeFind(findGraspsGoal);
  ros::spin();
