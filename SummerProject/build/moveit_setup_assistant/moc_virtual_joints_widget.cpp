...
void moveit_setup_assistant::VirtualJointsWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VirtualJointsWidget::referenceFrameChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject moveit_setup_assistant::VirtualJointsWidget::staticMetaObject = {
    { &SetupScreenWidget::staticMetaObject, qt_meta_stringdata_moveit_setup_assistant__VirtualJointsWidget.data,
      qt_meta_data_moveit_setup_assistant__VirtualJointsWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
