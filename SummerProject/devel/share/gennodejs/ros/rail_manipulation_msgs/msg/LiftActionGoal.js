...
class LiftActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = LiftGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LiftActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = LiftGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new LiftGoal()
    }
