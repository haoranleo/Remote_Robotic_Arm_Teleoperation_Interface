...
#include "../../src/moveit_setup_assistant/src/tools/collision_linear_model.h"
...
const QMetaObject CollisionLinearModel::staticMetaObject = {
    { &QAbstractProxyModel::staticMetaObject, qt_meta_stringdata_CollisionLinearModel.data,
      qt_meta_data_CollisionLinearModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CollisionLinearModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CollisionLinearModel.stringdata0))
        return static_cast<void*>(const_cast< CollisionLinearModel*>(this));
