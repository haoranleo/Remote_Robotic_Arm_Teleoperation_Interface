...
class Pr2GripperCommandResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type Pr2GripperCommandResult
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type Pr2GripperCommandResult
    let len;
    let data = new Pr2GripperCommandResult(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new Pr2GripperCommandResult(null);
...
module.exports = Pr2GripperCommandResult;
