...
class MoveToJointPoseFeedback {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MoveToJointPoseFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveToJointPoseFeedback(null);
...
module.exports = MoveToJointPoseFeedback;
