    ...
    try:
      ...
      for val1 in self.action_goal.goal.planning_options.planning_scene_diff.robot_state.attached_collision_objects:
        ...
        for val3 in _v96.plane_poses:
          ...
          _x = _v105
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v96.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
      ...
      for val1 in self.action_result.result.trajectory_start.attached_collision_objects:
        ...
        for val3 in _v131.plane_poses:
          ...
          _x = _v140
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v131.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.action_goal.goal.request.start_state.attached_collision_objects:
        ...
        _v338 = _v337.header
        buff.write(_get_struct_I().pack(_v338.seq))
        _v339 = _v338.stamp
        _x = _v339
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v338.frame_id
      ...
      for val1 in self.action_goal.goal.request.goal_constraints:
        ...
        for val2 in val1.position_constraints:
          _v341 = val2.header
          buff.write(_get_struct_I().pack(_v341.seq))
          _v342 = _v341.stamp
          _x = _v342
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v341.frame_id
        ...
        for val2 in val1.orientation_constraints:
          _v349 = val2.header
          buff.write(_get_struct_I().pack(_v349.seq))
          _v350 = _v349.stamp
          _x = _v350
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v349.frame_id
        ...
        for val2 in val1.visibility_constraints:
          ...
          _v353 = _v352.header
          buff.write(_get_struct_I().pack(_v353.seq))
          _v354 = _v353.stamp
          _x = _v354
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v353.frame_id
          ...
          _v359 = _v358.header
          buff.write(_get_struct_I().pack(_v359.seq))
          _v360 = _v359.stamp
          _x = _v360
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v359.frame_id
      ...
      for val1 in self.action_goal.goal.request.path_constraints.position_constraints:
        _v364 = val1.header
        buff.write(_get_struct_I().pack(_v364.seq))
        _v365 = _v364.stamp
        _x = _v365
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v364.frame_id
      ...
      for val1 in self.action_goal.goal.request.path_constraints.orientation_constraints:
        _v372 = val1.header
        buff.write(_get_struct_I().pack(_v372.seq))
        _v373 = _v372.stamp
        _x = _v373
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v372.frame_id
      ...
      for val1 in self.action_goal.goal.request.path_constraints.visibility_constraints:
        ...
        _v376 = _v375.header
        buff.write(_get_struct_I().pack(_v376.seq))
        _v377 = _v376.stamp
        _x = _v377
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v376.frame_id
        ...
        _v382 = _v381.header
        buff.write(_get_struct_I().pack(_v382.seq))
        _v383 = _v382.stamp
        _x = _v383
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v382.frame_id
      ...
      for val1 in self.action_goal.goal.request.trajectory_constraints.constraints:
        ...
        for val2 in val1.position_constraints:
          _v387 = val2.header
          buff.write(_get_struct_I().pack(_v387.seq))
          _v388 = _v387.stamp
          _x = _v388
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v387.frame_id
        ...
        for val2 in val1.visibility_constraints:
          ...
          _v399 = _v398.header
          buff.write(_get_struct_I().pack(_v399.seq))
          _v400 = _v399.stamp
          _x = _v400
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v399.frame_id
          ...
          _v405 = _v404.header
          buff.write(_get_struct_I().pack(_v405.seq))
          _v406 = _v405.stamp
          _x = _v406
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v405.frame_id
      ...
      for val1 in self.action_goal.goal.planning_options.planning_scene_diff.robot_state.attached_collision_objects:
        ...
        _v416 = val1.object
        _v417 = _v416.header
        buff.write(_get_struct_I().pack(_v417.seq))
        _v418 = _v417.stamp
        _x = _v418
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v417.frame_id
        ...
        for val3 in _v416.plane_poses:
          ...
          _x = _v425
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v416.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
        ...
        _v427 = _v426.header
        buff.write(_get_struct_I().pack(_v427.seq))
        _v428 = _v427.stamp
        _x = _v428
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v427.frame_id
      ...
      for val1 in self.action_result.result.trajectory_start.attached_collision_objects:
        ...
        _v451 = val1.object
        _v452 = _v451.header
        buff.write(_get_struct_I().pack(_v452.seq))
        _v453 = _v452.stamp
        _x = _v453
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v452.frame_id
        ...
        for val3 in _v451.plane_poses:
          ...
          _x = _v460
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v451.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
        ...
        _v462 = _v461.header
        buff.write(_get_struct_I().pack(_v462.seq))
        _v463 = _v462.stamp
        _x = _v463
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v462.frame_id
