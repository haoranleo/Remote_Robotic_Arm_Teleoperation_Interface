...
class Pr2GripperCommandActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new Pr2GripperCommandGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = Pr2GripperCommandGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Pr2GripperCommandActionGoal(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal_id]
    data.goal_id = actionlib_msgs.msg.GoalID.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal]
    data.goal = Pr2GripperCommandGoal.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Pr2GripperCommandActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = Pr2GripperCommandGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new Pr2GripperCommandGoal()
    }
...
module.exports = Pr2GripperCommandActionGoal;
