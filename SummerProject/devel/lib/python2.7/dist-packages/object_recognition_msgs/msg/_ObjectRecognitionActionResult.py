...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.result.recognized_objects.cooccurrence))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.result.recognized_objects.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      self.result.recognized_objects.cooccurrence = struct.unpack(pattern, str[start:end])
      return self
