...
class SingleJointPositionActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SingleJointPositionFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SingleJointPositionActionFeedback(null);
    ...
    data.feedback = SingleJointPositionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += SingleJointPositionFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SingleJointPositionActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = SingleJointPositionFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new SingleJointPositionFeedback()
    }
...
module.exports = SingleJointPositionActionFeedback;
