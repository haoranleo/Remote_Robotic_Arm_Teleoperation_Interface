  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.goal.place_locations:
        ...
        _v169 = _v168.header
        buff.write(_get_struct_I().pack(_v169.seq))
        _v170 = _v169.stamp
        _x = _v170
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v169.frame_id
      ...
      for val1 in self.goal.path_constraints.visibility_constraints:
        ...
        _v189 = _v188.header
        buff.write(_get_struct_I().pack(_v189.seq))
        _v190 = _v189.stamp
        _x = _v190
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v189.frame_id
        ...
        _v195 = _v194.header
        buff.write(_get_struct_I().pack(_v195.seq))
        _v196 = _v195.stamp
        _x = _v196
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v195.frame_id
      ...
      for val1 in self.goal.planning_options.planning_scene_diff.robot_state.attached_collision_objects:
        ...
        for val3 in _v206.plane_poses:
          ...
          _x = _v215
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v206.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
