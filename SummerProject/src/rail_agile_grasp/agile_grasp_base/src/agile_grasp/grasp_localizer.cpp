...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void GraspLocalizer::executeFind(const rail_agile_grasp_msgs::FindGraspsGoal::ConstPtr &goal) 
{
...
{
  //rail_agile_grasp_msgs::FindGraspsGoal::ConstPtr findGraspsGoal;
  //executeFind(findGraspsGoal);
  ros::Rate rate(1);
  std::vector<int> indices(0);
  ...
  while (ros::ok())
  {
    ...
    if (num_clouds_received_ == num_clouds_)
    {
      ...
      // publish handles
	  //grasps_with_workspace_pub_.publish(createGraspsMsg(handles_));
      grasps_pub_.publish(createGraspsMsg(handles_));
      ros::Duration(1.0).sleep();

      // publish hands contained in handles
	  //grasps_with_workspace_pub_.publish(createGraspsMsgFromHands(handles_));
      grasps_pub_.publish(createGraspsMsgFromHands(handles_));
      ros::Duration(1.0).sleep();
...
void GraspLocalizer::findGrasps()
{
  ...
  while (ros::ok())
  {
    ...
    if (num_clouds_received_ == num_clouds_)
    {
      ...
      grasps_with_workspace_pub_.publish(createGraspsMsg(hands_));
