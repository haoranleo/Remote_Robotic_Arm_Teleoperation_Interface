...
(cl:defmethod cl:initialize-instance :after ((m <Grasp>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Grasp)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rail_agile_grasp_msgs-msg:<Grasp> is deprecated: use rail_agile_grasp_msgs-msg:Grasp instead.")))

(cl:ensure-generic-function 'center-val :lambda-list '(m))
(cl:defmethod center-val ((m <Grasp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rail_agile_grasp_msgs-msg:center-val is deprecated.  Use rail_agile_grasp_msgs-msg:center instead.")
  (center m))

(cl:ensure-generic-function 'axis-val :lambda-list '(m))
(cl:defmethod axis-val ((m <Grasp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rail_agile_grasp_msgs-msg:axis-val is deprecated.  Use rail_agile_grasp_msgs-msg:axis instead.")
  (axis m))

(cl:ensure-generic-function 'approach-val :lambda-list '(m))
(cl:defmethod approach-val ((m <Grasp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rail_agile_grasp_msgs-msg:approach-val is deprecated.  Use rail_agile_grasp_msgs-msg:approach instead.")
  (approach m))

(cl:ensure-generic-function 'surface_center-val :lambda-list '(m))
(cl:defmethod surface_center-val ((m <Grasp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rail_agile_grasp_msgs-msg:surface_center-val is deprecated.  Use rail_agile_grasp_msgs-msg:surface_center instead.")
  (surface_center m))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <Grasp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rail_agile_grasp_msgs-msg:width-val is deprecated.  Use rail_agile_grasp_msgs-msg:width instead.")
  (width m))
