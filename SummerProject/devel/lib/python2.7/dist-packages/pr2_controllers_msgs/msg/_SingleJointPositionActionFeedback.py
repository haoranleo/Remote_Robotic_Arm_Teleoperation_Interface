...
"""autogenerated by genpy from pr2_controllers_msgs/SingleJointPositionActionFeedback.msg. Do not edit."""
import sys
...
class SingleJointPositionActionFeedback(genpy.Message):
  ...
  _type = "pr2_controllers_msgs/SingleJointPositionActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pr2_controllers_msgs/SingleJointPositionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = pr2_controllers_msgs.msg.SingleJointPositionFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = pr2_controllers_msgs.msg.SingleJointPositionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_3d().pack(_x.feedback.position, _x.feedback.velocity, _x.feedback.error))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.position, _x.feedback.velocity, _x.feedback.error,) = _get_struct_3d().unpack(str[start:end])
      return self
