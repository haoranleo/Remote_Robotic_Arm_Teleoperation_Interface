...
class StoreActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = StoreResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new StoreActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = StoreResult.Resolve(msg.result)
    }
    else {
      resolved.result = new StoreResult()
    }
