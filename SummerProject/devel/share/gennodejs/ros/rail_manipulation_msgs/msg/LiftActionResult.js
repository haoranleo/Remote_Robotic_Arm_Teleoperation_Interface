...
class LiftActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = LiftResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LiftActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = LiftResult.Resolve(msg.result)
    }
    else {
      resolved.result = new LiftResult()
    }
...
module.exports = LiftActionResult;
