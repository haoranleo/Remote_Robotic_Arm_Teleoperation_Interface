...
if(agile_grasp_base_CONFIG_INCLUDED)
  return()
endif()
set(agile_grasp_base_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("FALSE" STREQUAL "TRUE")
  set(agile_grasp_base_SOURCE_PREFIX /home/orsteam/SummerProject/src/rail_agile_grasp/agile_grasp_base)
  set(agile_grasp_base_DEVEL_PREFIX /home/orsteam/SummerProject/devel)
  set(agile_grasp_base_INSTALL_PREFIX "")
  set(agile_grasp_base_PREFIX ${agile_grasp_base_DEVEL_PREFIX})
else()
  set(agile_grasp_base_SOURCE_PREFIX "")
  set(agile_grasp_base_DEVEL_PREFIX "")
  set(agile_grasp_base_INSTALL_PREFIX /home/orsteam/SummerProject/install)
  set(agile_grasp_base_PREFIX ${agile_grasp_base_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'agile_grasp_base' is deprecated")
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(agile_grasp_base_LIBRARY_DIRS ${lib_path})
      list(APPEND agile_grasp_base_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'agile_grasp_base'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND agile_grasp_base_LIBRARIES ${lib})
    endif()
  endif()
...
set(agile_grasp_base_EXPORTED_TARGETS "agile_grasp_base_generate_messages_cpp;agile_grasp_base_generate_messages_eus;agile_grasp_base_generate_messages_lisp;agile_grasp_base_generate_messages_nodejs;agile_grasp_base_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${agile_grasp_base_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "cmake_modules;cv_bridge;eigen_conversions;geometry_msgs;message_runtime;pcl_conversions;roscpp;sensor_msgs;std_msgs;visualization_msgs;tf")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 agile_grasp_base_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${agile_grasp_base_dep}_FOUND)
      find_package(${agile_grasp_base_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${agile_grasp_base_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(agile_grasp_base_INCLUDE_DIRS ${${agile_grasp_base_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(agile_grasp_base_LIBRARIES ${agile_grasp_base_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${agile_grasp_base_dep}_LIBRARIES})
  _list_append_deduplicate(agile_grasp_base_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(agile_grasp_base_LIBRARIES ${agile_grasp_base_LIBRARIES})

  _list_append_unique(agile_grasp_base_LIBRARY_DIRS ${${agile_grasp_base_dep}_LIBRARY_DIRS})
  list(APPEND agile_grasp_base_EXPORTED_TARGETS ${${agile_grasp_base_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "agile_grasp_base-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${agile_grasp_base_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
