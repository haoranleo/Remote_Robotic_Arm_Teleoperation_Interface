...
"""autogenerated by genpy from agile_grasp_base/Grasps.msg. Do not edit."""
import sys
...
import agile_grasp_base.msg
import std_msgs.msg

class Grasps(genpy.Message):
  _md5sum = "3b718d1a7961f2593896b8cec7c8808e"
  _type = "agile_grasp_base/Grasps"
...
float32 data"""
  ...
  _slot_types = ['std_msgs/Header','agile_grasp_base/Grasp[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Grasps, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = agile_grasp_base.msg.Grasp()
        _v6 = val1.center
        _x = _v6
        start = end
        end += 24
