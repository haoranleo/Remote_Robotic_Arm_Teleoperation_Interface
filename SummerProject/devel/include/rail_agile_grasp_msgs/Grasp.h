// Generated by gencpp from file rail_agile_grasp_msgs/Grasp.msg
// DO NOT EDIT!


#ifndef RAIL_AGILE_GRASP_MSGS_MESSAGE_GRASP_H
#define RAIL_AGILE_GRASP_MSGS_MESSAGE_GRASP_H
...
struct Grasp_
{
  ...
  typedef boost::shared_ptr< ::rail_agile_grasp_msgs::Grasp_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::rail_agile_grasp_msgs::Grasp_<ContainerAllocator> const> ConstPtr;

}; // struct Grasp_

typedef ::rail_agile_grasp_msgs::Grasp_<std::allocator<void> > Grasp;

typedef boost::shared_ptr< ::rail_agile_grasp_msgs::Grasp > GraspPtr;
typedef boost::shared_ptr< ::rail_agile_grasp_msgs::Grasp const> GraspConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::rail_agile_grasp_msgs::Grasp_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::rail_agile_grasp_msgs::Grasp_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::rail_agile_grasp_msgs::Grasp_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::rail_agile_grasp_msgs::Grasp_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rail_agile_grasp_msgs::Grasp_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rail_agile_grasp_msgs::Grasp_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rail_agile_grasp_msgs::Grasp_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rail_agile_grasp_msgs::Grasp_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::rail_agile_grasp_msgs::Grasp_<ContainerAllocator> >
{
  ...
  static const char* value(const ::rail_agile_grasp_msgs::Grasp_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xe812ccd1fa0a0ad5ULL;
  static const uint64_t static_value2 = 0xbe105b582346ad98ULL;
};

template<class ContainerAllocator>
struct DataType< ::rail_agile_grasp_msgs::Grasp_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::rail_agile_grasp_msgs::Grasp_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::rail_agile_grasp_msgs::Grasp_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::rail_agile_grasp_msgs::Grasp_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rail_agile_grasp_msgs::Grasp_<ContainerAllocator>& v)
  {
    s << indent << "center: ";
    s << std::endl;
...
#endif // RAIL_AGILE_GRASP_MSGS_MESSAGE_GRASP_H
