...
(cl:defclass <Grasps> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (grasps
    :reader grasps
    :initarg :grasps
    :type (cl:vector rail_agile_grasp_msgs-msg:Grasp)
   :initform (cl:make-array 0 :element-type 'rail_agile_grasp_msgs-msg:Grasp :initial-element (cl:make-instance 'rail_agile_grasp_msgs-msg:Grasp))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Grasps>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Grasps)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rail_agile_grasp_msgs-msg:<Grasps> is deprecated: use rail_agile_grasp_msgs-msg:Grasps instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Grasps>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'grasps)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'rail_agile_grasp_msgs-msg:Grasp))
