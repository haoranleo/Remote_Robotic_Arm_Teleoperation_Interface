...
(cl:defmethod cl:initialize-instance :after ((m <PointHeadGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PointHeadGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr2_controllers_msgs-msg:<PointHeadGoal> is deprecated: use pr2_controllers_msgs-msg:PointHeadGoal instead.")))

(cl:ensure-generic-function 'target-val :lambda-list '(m))
(cl:defmethod target-val ((m <PointHeadGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr2_controllers_msgs-msg:target-val is deprecated.  Use pr2_controllers_msgs-msg:target instead.")
  (target m))

(cl:ensure-generic-function 'pointing_axis-val :lambda-list '(m))
(cl:defmethod pointing_axis-val ((m <PointHeadGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr2_controllers_msgs-msg:pointing_axis-val is deprecated.  Use pr2_controllers_msgs-msg:pointing_axis instead.")
  (pointing_axis m))

(cl:ensure-generic-function 'pointing_frame-val :lambda-list '(m))
(cl:defmethod pointing_frame-val ((m <PointHeadGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr2_controllers_msgs-msg:pointing_frame-val is deprecated.  Use pr2_controllers_msgs-msg:pointing_frame instead.")
  (pointing_frame m))

(cl:ensure-generic-function 'min_duration-val :lambda-list '(m))
(cl:defmethod min_duration-val ((m <PointHeadGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr2_controllers_msgs-msg:min_duration-val is deprecated.  Use pr2_controllers_msgs-msg:min_duration instead.")
  (min_duration m))

(cl:ensure-generic-function 'max_velocity-val :lambda-list '(m))
(cl:defmethod max_velocity-val ((m <PointHeadGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr2_controllers_msgs-msg:max_velocity-val is deprecated.  Use pr2_controllers_msgs-msg:max_velocity instead.")
  (max_velocity m))
