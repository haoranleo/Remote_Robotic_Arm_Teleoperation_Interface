...
(cl:defclass <JointTrajectoryActionGoal> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (goal
    :reader goal
    :initarg :goal
    :type pr2_controllers_msgs-msg:JointTrajectoryGoal
    :initform (cl:make-instance 'pr2_controllers_msgs-msg:JointTrajectoryGoal)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <JointTrajectoryActionGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointTrajectoryActionGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr2_controllers_msgs-msg:<JointTrajectoryActionGoal> is deprecated: use pr2_controllers_msgs-msg:JointTrajectoryActionGoal instead.")))
