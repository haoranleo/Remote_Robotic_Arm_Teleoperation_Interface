...
class Pr2GripperCommand {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type Pr2GripperCommand
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type Pr2GripperCommand
    let len;
    let data = new Pr2GripperCommand(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new Pr2GripperCommand(null);
...
module.exports = Pr2GripperCommand;
