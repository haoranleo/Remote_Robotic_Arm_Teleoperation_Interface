...
void moveit_setup_assistant::DoubleListWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DoubleListWidget::doneEditing)) {
                *result = 0;
            }
        }
        {
            typedef void (DoubleListWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DoubleListWidget::cancelEditing)) {
                *result = 1;
            }
        }
        {
            typedef void (DoubleListWidget::*_t)(std::vector<std::string> );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DoubleListWidget::previewSelected)) {
                *result = 2;
            }
        }
        {
            typedef void (DoubleListWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DoubleListWidget::selectionUpdated)) {
                *result = 3;
            }
        }
    }
...
const QMetaObject moveit_setup_assistant::DoubleListWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_moveit_setup_assistant__DoubleListWidget.data,
      qt_meta_data_moveit_setup_assistant__DoubleListWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
