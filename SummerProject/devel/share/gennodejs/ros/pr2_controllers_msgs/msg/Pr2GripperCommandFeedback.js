...
class Pr2GripperCommandFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Pr2GripperCommandFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new Pr2GripperCommandFeedback(null);
...
module.exports = Pr2GripperCommandFeedback;
