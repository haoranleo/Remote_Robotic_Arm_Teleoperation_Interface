...
class Pr2GripperCommandActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new Pr2GripperCommandFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = Pr2GripperCommandFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Pr2GripperCommandActionFeedback(null);
    ...
    data.feedback = Pr2GripperCommandFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Pr2GripperCommandActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = Pr2GripperCommandFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new Pr2GripperCommandFeedback()
    }
...
module.exports = Pr2GripperCommandActionFeedback;
