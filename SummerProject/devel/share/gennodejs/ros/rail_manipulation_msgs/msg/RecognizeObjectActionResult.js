...
class RecognizeObjectActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new RecognizeObjectResult();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type RecognizeObjectActionResult
    // Serialize message field [header]
    bufferOffset = std_msgs.msg.Header.serialize(obj.header, buffer, bufferOffset);
    // Serialize message field [status]
    bufferOffset = actionlib_msgs.msg.GoalStatus.serialize(obj.status, buffer, bufferOffset);
    // Serialize message field [result]
    bufferOffset = RecognizeObjectResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type RecognizeObjectActionResult
    let len;
    let data = new RecognizeObjectActionResult(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [status]
    data.status = actionlib_msgs.msg.GoalStatus.deserialize(buffer, bufferOffset);
    // Deserialize message field [result]
    data.result = RecognizeObjectResult.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += RecognizeObjectResult.getMessageSize(object.result);
    return length;
  }
  ...
  static md5sum() {
    ...
    return '81131dbba1c4b61cbc49d5e2fba2af3c';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RecognizeObjectActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = RecognizeObjectResult.Resolve(msg.result)
    }
    else {
      resolved.result = new RecognizeObjectResult()
    }
...
module.exports = RecognizeObjectActionResult;
