...
"""autogenerated by genpy from rail_agile_grasp_msgs/FindGraspsActionFeedback.msg. Do not edit."""
import sys
...
class FindGraspsActionFeedback(genpy.Message):
  _md5sum = "7c3f461f497e18b55fe00255efcfe5b7"
  _type = "rail_agile_grasp_msgs/FindGraspsActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','rail_agile_grasp_msgs/FindGraspsFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FindGraspsActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = rail_agile_grasp_msgs.msg.FindGraspsFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = rail_agile_grasp_msgs.msg.FindGraspsFeedback()
