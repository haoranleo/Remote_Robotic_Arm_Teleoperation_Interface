...
class VerifyGraspActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new VerifyGraspResult();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = VerifyGraspResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new VerifyGraspActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = VerifyGraspResult.Resolve(msg.result)
    }
    else {
      resolved.result = new VerifyGraspResult()
    }
...
module.exports = VerifyGraspActionResult;
