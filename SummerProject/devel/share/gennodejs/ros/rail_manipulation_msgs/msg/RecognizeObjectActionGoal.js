...
class RecognizeObjectActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new RecognizeObjectGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = RecognizeObjectGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RecognizeObjectActionGoal(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal_id]
    data.goal_id = actionlib_msgs.msg.GoalID.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal]
    data.goal = RecognizeObjectGoal.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += RecognizeObjectGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static md5sum() {
    ...
    return 'f5e7e8a51ceb1ac5ce7473f43dcd66c4';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RecognizeObjectActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = RecognizeObjectGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new RecognizeObjectGoal()
    }
...
module.exports = RecognizeObjectActionGoal;
