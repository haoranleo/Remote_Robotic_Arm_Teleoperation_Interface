...
let FindGraspsGoal = require('./FindGraspsGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class FindGraspsActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = FindGraspsGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += FindGraspsGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FindGraspsActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = FindGraspsGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new FindGraspsGoal()
    }
...
module.exports = FindGraspsActionGoal;
