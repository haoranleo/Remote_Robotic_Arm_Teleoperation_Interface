...
class JointTrajectoryActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = JointTrajectoryFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new JointTrajectoryActionFeedback(null);
    ...
    data.feedback = JointTrajectoryFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new JointTrajectoryActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = JointTrajectoryFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new JointTrajectoryFeedback()
    }
...
module.exports = JointTrajectoryActionFeedback;
