...
class StoreActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = StoreGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += StoreGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new StoreActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = StoreGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new StoreGoal()
    }
...
module.exports = StoreActionGoal;
