...
"""autogenerated by genpy from rail_agile_grasp_msgs/FindGraspsActionResult.msg. Do not edit."""
import sys
...
class FindGraspsActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "rail_agile_grasp_msgs/FindGraspsActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','rail_agile_grasp_msgs/FindGraspsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FindGraspsActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = rail_agile_grasp_msgs.msg.FindGraspsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = rail_agile_grasp_msgs.msg.FindGraspsResult()
