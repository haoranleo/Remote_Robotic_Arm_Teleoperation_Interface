...
class RecognizeObjectFeedback {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RecognizeObjectFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RecognizeObjectFeedback(null);
...
module.exports = RecognizeObjectFeedback;
