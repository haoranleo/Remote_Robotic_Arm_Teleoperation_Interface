...
void moveit_setup_assistant::GroupEditWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GroupEditWidget::saveJoints)) {
                *result = 0;
            }
        }
        {
            typedef void (GroupEditWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GroupEditWidget::saveLinks)) {
                *result = 1;
            }
        }
        {
            typedef void (GroupEditWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GroupEditWidget::saveChain)) {
                *result = 2;
            }
        }
        {
            typedef void (GroupEditWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GroupEditWidget::saveSubgroups)) {
                *result = 3;
            }
        }
        {
            typedef void (GroupEditWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GroupEditWidget::save)) {
                *result = 4;
            }
        }
        {
            typedef void (GroupEditWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GroupEditWidget::cancelEditing)) {
                *result = 5;
            }
        }
        {
            typedef void (GroupEditWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GroupEditWidget::deleteGroup)) {
                *result = 6;
            }
        }
    }
...
const QMetaObject moveit_setup_assistant::GroupEditWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_moveit_setup_assistant__GroupEditWidget.data,
      qt_meta_data_moveit_setup_assistant__GroupEditWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
