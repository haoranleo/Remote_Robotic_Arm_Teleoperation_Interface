  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.action_goal.goal.place_locations:
        ...
        _v228 = _v227.header
        buff.write(_get_struct_I().pack(_v228.seq))
        _v229 = _v228.stamp
        _x = _v229
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v228.frame_id
        ...
        _v232 = _v231.header
        buff.write(_get_struct_I().pack(_v232.seq))
        _v233 = _v232.stamp
        _x = _v233
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v232.frame_id
        ...
        _v239 = _v238.header
        buff.write(_get_struct_I().pack(_v239.seq))
        _v240 = _v239.stamp
        _x = _v240
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v239.frame_id
      ...
      for val1 in self.action_goal.goal.path_constraints.visibility_constraints:
        ...
        _v265 = _v264.header
        buff.write(_get_struct_I().pack(_v265.seq))
        _v266 = _v265.stamp
        _x = _v266
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v265.frame_id
      ...
      for val1 in self.action_goal.goal.planning_options.planning_scene_diff.robot_state.attached_collision_objects:
        ...
        for val3 in _v276.plane_poses:
          ...
          _x = _v285
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v276.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
      ...
      for val1 in self.action_goal.goal.planning_options.planning_scene_diff.fixed_frame_transforms:
        _v290 = val1.header
        buff.write(_get_struct_I().pack(_v290.seq))
        _v291 = _v290.stamp
        _x = _v291
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v290.frame_id
      ...
      for val1 in self.action_result.result.trajectory_start.attached_collision_objects:
        ...
        for val3 in _v311.plane_poses:
          ...
          _x = _v320
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v311.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
        ...
        _v322 = _v321.header
        buff.write(_get_struct_I().pack(_v322.seq))
        _v323 = _v322.stamp
        _x = _v323
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v322.frame_id
      ...
      for val1 in self.action_result.result.trajectory_stages:
        ...
        _v326 = _v325.header
        buff.write(_get_struct_I().pack(_v326.seq))
        _v327 = _v326.stamp
        _x = _v327
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v326.frame_id
