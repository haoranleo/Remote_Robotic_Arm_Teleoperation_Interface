...
class PrimitiveActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PrimitiveGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PrimitiveActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = PrimitiveGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new PrimitiveGoal()
    }
...
module.exports = PrimitiveActionGoal;
