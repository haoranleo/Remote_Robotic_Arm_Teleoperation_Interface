...
if("TRUE" STREQUAL "TRUE")
  set(moveit_fake_controller_manager_SOURCE_PREFIX /home/orsteam/SummerProject/src/moveit_plugins/moveit_fake_controller_manager)
  set(moveit_fake_controller_manager_DEVEL_PREFIX /home/orsteam/SummerProject/devel)
  ...
  set(moveit_fake_controller_manager_INSTALL_PREFIX /home/orsteam/SummerProject/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'moveit_fake_controller_manager' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Michael Görner <me@v4hn.de>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'moveit_fake_controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/orsteam/SummerProject/src/moveit_plugins/moveit_fake_controller_manager/${idir}'.  Ask the maintainer 'Michael Görner <me@v4hn.de>' to fix it.")
    endif()
