...
class ObjectRecognitionAction {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ObjectRecognitionAction
    // Serialize message field [action_goal]
    bufferOffset = ObjectRecognitionActionGoal.serialize(obj.action_goal, buffer, bufferOffset);
    // Serialize message field [action_result]
    bufferOffset = ObjectRecognitionActionResult.serialize(obj.action_result, buffer, bufferOffset);
    // Serialize message field [action_feedback]
    bufferOffset = ObjectRecognitionActionFeedback.serialize(obj.action_feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ObjectRecognitionAction
    let len;
    let data = new ObjectRecognitionAction(null);
    // Deserialize message field [action_goal]
    data.action_goal = ObjectRecognitionActionGoal.deserialize(buffer, bufferOffset);
    // Deserialize message field [action_result]
    data.action_result = ObjectRecognitionActionResult.deserialize(buffer, bufferOffset);
    // Deserialize message field [action_feedback]
    data.action_feedback = ObjectRecognitionActionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += ObjectRecognitionActionGoal.getMessageSize(object.action_goal);
    length += ObjectRecognitionActionResult.getMessageSize(object.action_result);
    length += ObjectRecognitionActionFeedback.getMessageSize(object.action_feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ObjectRecognitionAction(null);
    if (msg.action_goal !== undefined) {
      resolved.action_goal = ObjectRecognitionActionGoal.Resolve(msg.action_goal)
    }
    else {
      resolved.action_goal = new ObjectRecognitionActionGoal()
    }

    if (msg.action_result !== undefined) {
      resolved.action_result = ObjectRecognitionActionResult.Resolve(msg.action_result)
    }
    else {
      resolved.action_result = new ObjectRecognitionActionResult()
    }

    if (msg.action_feedback !== undefined) {
      resolved.action_feedback = ObjectRecognitionActionFeedback.Resolve(msg.action_feedback)
    }
    else {
      resolved.action_feedback = new ObjectRecognitionActionFeedback()
    }
...
module.exports = ObjectRecognitionAction;
