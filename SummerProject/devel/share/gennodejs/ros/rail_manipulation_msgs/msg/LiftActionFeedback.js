...
class LiftActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new LiftFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = LiftFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LiftActionFeedback(null);
    ...
    data.feedback = LiftFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += LiftFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LiftActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = LiftFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new LiftFeedback()
    }
...
module.exports = LiftActionFeedback;
