...
class SegmentedObjectList {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SegmentedObjectList
    ...
    obj.objects.forEach((val) => {
      bufferOffset = SegmentedObject.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SegmentedObjectList
    let len;
    let data = new SegmentedObjectList(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.objects[i] = SegmentedObject.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.objects.forEach((val) => {
      length += SegmentedObject.getMessageSize(val);
    });
    return length + 5;
  }
  ...
  static md5sum() {
    ...
    return 'e9f9c1bd56b58f2c315f6050f2f8fad8';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SegmentedObjectList(null);
    ...
    if (msg.objects !== undefined) {
      ...
      for (let i = 0; i < resolved.objects.length; ++i) {
        resolved.objects[i] = SegmentedObject.Resolve(msg.objects[i]);
      }
    }
    else {
      resolved.objects = []
...
module.exports = SegmentedObjectList;
