    ...
    try:
      ...
      for val1 in self.motion_plan_request.start_state.attached_collision_objects:
        ...
        for val3 in _v185.plane_poses:
          ...
          _x = _v194
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v185.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
      ...
      for val1 in self.motion_plan_request.path_constraints.visibility_constraints:
        ...
        _v234 = _v233.header
        buff.write(_get_struct_I().pack(_v234.seq))
        _v235 = _v234.stamp
        _x = _v235
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v234.frame_id
    ...
    try:
      ...
      for val1 in self.motion_plan_response.trajectory_start.attached_collision_objects:
        ...
        for val3 in _v363.plane_poses:
          ...
          _x = _v372
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v363.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
        ...
        _v374 = _v373.header
        buff.write(_get_struct_I().pack(_v374.seq))
        _v375 = _v374.stamp
        _x = _v375
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v374.frame_id
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.motion_plan_response.trajectory_start.attached_collision_objects:
        ...
        _v419 = val1.object
        _v420 = _v419.header
        buff.write(_get_struct_I().pack(_v420.seq))
        _v421 = _v420.stamp
        _x = _v421
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v420.frame_id
        ...
        for val3 in _v419.plane_poses:
          ...
          _x = _v428
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v419.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
