...
(cl:defmethod cl:initialize-instance :after ((m <Grasp>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Grasp)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name agile_grasp_base-msg:<Grasp> is deprecated: use agile_grasp_base-msg:Grasp instead.")))

(cl:ensure-generic-function 'center-val :lambda-list '(m))
(cl:defmethod center-val ((m <Grasp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader agile_grasp_base-msg:center-val is deprecated.  Use agile_grasp_base-msg:center instead.")
  (center m))

(cl:ensure-generic-function 'axis-val :lambda-list '(m))
(cl:defmethod axis-val ((m <Grasp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader agile_grasp_base-msg:axis-val is deprecated.  Use agile_grasp_base-msg:axis instead.")
  (axis m))

(cl:ensure-generic-function 'approach-val :lambda-list '(m))
(cl:defmethod approach-val ((m <Grasp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader agile_grasp_base-msg:approach-val is deprecated.  Use agile_grasp_base-msg:approach instead.")
  (approach m))

(cl:ensure-generic-function 'surface_center-val :lambda-list '(m))
(cl:defmethod surface_center-val ((m <Grasp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader agile_grasp_base-msg:surface_center-val is deprecated.  Use agile_grasp_base-msg:surface_center instead.")
  (surface_center m))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <Grasp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader agile_grasp_base-msg:width-val is deprecated.  Use agile_grasp_base-msg:width instead.")
  (width m))
