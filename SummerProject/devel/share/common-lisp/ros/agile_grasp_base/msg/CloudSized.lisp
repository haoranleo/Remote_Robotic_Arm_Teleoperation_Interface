...
(cl:defmethod cl:initialize-instance :after ((m <CloudSized>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CloudSized)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name agile_grasp_base-msg:<CloudSized> is deprecated: use agile_grasp_base-msg:CloudSized instead.")))

(cl:ensure-generic-function 'cloud-val :lambda-list '(m))
(cl:defmethod cloud-val ((m <CloudSized>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader agile_grasp_base-msg:cloud-val is deprecated.  Use agile_grasp_base-msg:cloud instead.")
  (cloud m))

(cl:ensure-generic-function 'size_left-val :lambda-list '(m))
(cl:defmethod size_left-val ((m <CloudSized>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader agile_grasp_base-msg:size_left-val is deprecated.  Use agile_grasp_base-msg:size_left instead.")
  (size_left m))
