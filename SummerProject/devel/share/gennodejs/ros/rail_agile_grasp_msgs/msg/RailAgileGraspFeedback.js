...
class RailAgileGraspFeedback {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RailAgileGraspFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RailAgileGraspFeedback(null);
...
module.exports = RailAgileGraspFeedback;
