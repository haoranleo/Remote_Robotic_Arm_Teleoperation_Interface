...
class JointTrajectoryActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = JointTrajectoryResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new JointTrajectoryActionResult(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [status]
    data.status = actionlib_msgs.msg.GoalStatus.deserialize(buffer, bufferOffset);
    // Deserialize message field [result]
    data.result = JointTrajectoryResult.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new JointTrajectoryActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = JointTrajectoryResult.Resolve(msg.result)
    }
    else {
      resolved.result = new JointTrajectoryResult()
    }
...
module.exports = JointTrajectoryActionResult;
