...
class RecognizeObjectActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new RecognizeObjectFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = RecognizeObjectFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RecognizeObjectActionFeedback(null);
    ...
    data.feedback = RecognizeObjectFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += RecognizeObjectFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RecognizeObjectActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = RecognizeObjectFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new RecognizeObjectFeedback()
    }
...
module.exports = RecognizeObjectActionFeedback;
