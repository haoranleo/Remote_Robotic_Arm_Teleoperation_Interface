  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.request.start_state.attached_collision_objects:
        ...
        _v266 = _v265.header
        buff.write(_get_struct_I().pack(_v266.seq))
        _v267 = _v266.stamp
        _x = _v267
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v266.frame_id
      ...
      for val1 in self.request.goal_constraints:
        ...
        for val2 in val1.position_constraints:
          _v269 = val2.header
          buff.write(_get_struct_I().pack(_v269.seq))
          _v270 = _v269.stamp
          _x = _v270
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v269.frame_id
        ...
        for val2 in val1.visibility_constraints:
          ...
          _v281 = _v280.header
          buff.write(_get_struct_I().pack(_v281.seq))
          _v282 = _v281.stamp
          _x = _v282
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v281.frame_id
      ...
      for val1 in self.request.trajectory_constraints.constraints:
        ...
        for val2 in val1.orientation_constraints:
          _v323 = val2.header
          buff.write(_get_struct_I().pack(_v323.seq))
          _v324 = _v323.stamp
          _x = _v324
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v323.frame_id
      ...
      for val1 in self.planning_options.planning_scene_diff.robot_state.attached_collision_objects:
        ...
        _v344 = val1.object
        _v345 = _v344.header
        buff.write(_get_struct_I().pack(_v345.seq))
        _v346 = _v345.stamp
        _x = _v346
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v345.frame_id
        ...
        for val3 in _v344.plane_poses:
          ...
          _x = _v353
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v344.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
      ...
      for val1 in self.planning_options.planning_scene_diff.fixed_frame_transforms:
        _v358 = val1.header
        buff.write(_get_struct_I().pack(_v358.seq))
        _v359 = _v358.stamp
        _x = _v359
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v358.frame_id
