...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_B().pack(self.action_goal.goal.use_roi))
      length = len(self.action_goal.goal.filter_limits)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.action_goal.goal.filter_limits))
      _x = self
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.action_result.result.recognized_objects.cooccurrence))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.action_goal.goal.filter_limits = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.action_result.result.recognized_objects.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      self.action_result.result.recognized_objects.cooccurrence = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 12
