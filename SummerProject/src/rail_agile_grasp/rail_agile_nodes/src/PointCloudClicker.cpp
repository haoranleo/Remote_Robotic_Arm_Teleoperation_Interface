...
void PointCloudClicker::executeClickedPointCallback(const rail_agile_grasp_msgs::ClickImagePointGoal::ConstPtr &goal)
{
...
ROS_INFO("%d is the point cloud image width",fullPointCloudPtr->width);
ROS_INFO("%d is the point cloud image height",fullPointCloudPtr->height);
