...
"""autogenerated by genpy from pr2_controllers_msgs/SingleJointPositionAction.msg. Do not edit."""
import sys
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_d2id3I().pack(_x.action_goal.goal.position, _x.action_goal.goal.min_duration.secs, _x.action_goal.goal.min_duration.nsecs, _x.action_goal.goal.max_velocity, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_3d().pack(_x.action_feedback.feedback.position, _x.action_feedback.feedback.velocity, _x.action_feedback.feedback.error))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.position, _x.action_goal.goal.min_duration.secs, _x.action_goal.goal.min_duration.nsecs, _x.action_goal.goal.max_velocity, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_d2id3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_feedback.feedback.position, _x.action_feedback.feedback.velocity, _x.action_feedback.feedback.error,) = _get_struct_3d().unpack(str[start:end])
      return self
...
def _get_struct_3I():
    ...
    return _struct_3I
_struct_d2id3I = None
def _get_struct_d2id3I():
    global _struct_d2id3I
    if _struct_d2id3I is None:
        _struct_d2id3I = struct.Struct("<d2id3I")
    return _struct_d2id3I
_struct_2I = None
def _get_struct_2I():
    global _struct_2I
