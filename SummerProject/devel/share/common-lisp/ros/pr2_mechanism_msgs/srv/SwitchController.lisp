...
(cl:defmethod cl:initialize-instance :after ((m <SwitchController-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SwitchController-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr2_mechanism_msgs-srv:<SwitchController-request> is deprecated: use pr2_mechanism_msgs-srv:SwitchController-request instead.")))
...
(cl:defmethod start_controllers-val ((m <SwitchController-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr2_mechanism_msgs-srv:start_controllers-val is deprecated.  Use pr2_mechanism_msgs-srv:start_controllers instead.")
  (start_controllers m))
...
(cl:defmethod stop_controllers-val ((m <SwitchController-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr2_mechanism_msgs-srv:stop_controllers-val is deprecated.  Use pr2_mechanism_msgs-srv:stop_controllers instead.")
  (stop_controllers m))

(cl:ensure-generic-function 'strictness-val :lambda-list '(m))
(cl:defmethod strictness-val ((m <SwitchController-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr2_mechanism_msgs-srv:strictness-val is deprecated.  Use pr2_mechanism_msgs-srv:strictness instead.")
  (strictness m))
...
(cl:defmethod cl:initialize-instance :after ((m <SwitchController-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SwitchController-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr2_mechanism_msgs-srv:<SwitchController-response> is deprecated: use pr2_mechanism_msgs-srv:SwitchController-response instead.")))
