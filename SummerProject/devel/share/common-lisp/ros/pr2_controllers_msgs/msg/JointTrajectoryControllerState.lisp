...
(cl:defmethod cl:initialize-instance :after ((m <JointTrajectoryControllerState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointTrajectoryControllerState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr2_controllers_msgs-msg:<JointTrajectoryControllerState> is deprecated: use pr2_controllers_msgs-msg:JointTrajectoryControllerState instead.")))
...
(cl:defmethod joint_names-val ((m <JointTrajectoryControllerState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr2_controllers_msgs-msg:joint_names-val is deprecated.  Use pr2_controllers_msgs-msg:joint_names instead.")
  (joint_names m))

(cl:ensure-generic-function 'desired-val :lambda-list '(m))
(cl:defmethod desired-val ((m <JointTrajectoryControllerState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr2_controllers_msgs-msg:desired-val is deprecated.  Use pr2_controllers_msgs-msg:desired instead.")
  (desired m))

(cl:ensure-generic-function 'actual-val :lambda-list '(m))
(cl:defmethod actual-val ((m <JointTrajectoryControllerState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr2_controllers_msgs-msg:actual-val is deprecated.  Use pr2_controllers_msgs-msg:actual instead.")
  (actual m))
