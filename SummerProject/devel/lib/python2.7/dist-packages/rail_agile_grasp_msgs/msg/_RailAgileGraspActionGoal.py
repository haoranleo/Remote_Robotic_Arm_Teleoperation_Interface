...
"""autogenerated by genpy from rail_agile_grasp_msgs/RailAgileGraspActionGoal.msg. Do not edit."""
import sys
...
class RailAgileGraspActionGoal(genpy.Message):
  _md5sum = "b6ea1680e49cc568af5b3007a97778e9"
  _type = "rail_agile_grasp_msgs/RailAgileGraspActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','rail_agile_grasp_msgs/RailAgileGraspGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RailAgileGraspActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = rail_agile_grasp_msgs.msg.RailAgileGraspGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = rail_agile_grasp_msgs.msg.RailAgileGraspGoal()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_3B3I().pack(_x.goal.do_segment, _x.goal.do_pickup, _x.goal.do_one, _x.goal.segmented_object_list.header.seq, _x.goal.segmented_object_list.header.stamp.secs, _x.goal.segmented_object_list.header.stamp.nsecs))
      _x = self.goal.segmented_object_list.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_B().pack(self.goal.segmented_object_list.cleared))
      length = len(self.goal.segmented_object_list.objects)
      buff.write(_struct_I.pack(length))
      for val1 in self.goal.segmented_object_list.objects:
      ...
      _x = self
      buff.write(_get_struct_3I().pack(_x.goal.store_pose.header.seq, _x.goal.store_pose.header.stamp.secs, _x.goal.store_pose.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_7d().pack(_x.goal.store_pose.pose.position.x, _x.goal.store_pose.pose.position.y, _x.goal.store_pose.pose.position.z, _x.goal.store_pose.pose.orientation.x, _x.goal.store_pose.pose.orientation.y, _x.goal.store_pose.pose.orientation.z, _x.goal.store_pose.pose.orientation.w))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.do_segment, _x.goal.do_pickup, _x.goal.do_one, _x.goal.segmented_object_list.header.seq, _x.goal.segmented_object_list.header.stamp.secs, _x.goal.segmented_object_list.header.stamp.nsecs,) = _get_struct_3B3I().unpack(str[start:end])
      self.goal.do_segment = bool(self.goal.do_segment)
      self.goal.do_pickup = bool(self.goal.do_pickup)
      self.goal.do_one = bool(self.goal.do_one)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.goal.segmented_object_list.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.goal.segmented_object_list.header.frame_id = str[start:end]
      start = end
      end += 1
      (self.goal.segmented_object_list.cleared,) = _get_struct_B().unpack(str[start:end])
      self.goal.segmented_object_list.cleared = bool(self.goal.segmented_object_list.cleared)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.goal.segmented_object_list.objects = []
      for i in range(0, length):
        ...
        self.goal.segmented_object_list.objects.append(val1)
      _x = self
      start = end
      end += 12
      (_x.goal.store_pose.header.seq, _x.goal.store_pose.header.stamp.secs, _x.goal.store_pose.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.goal.store_pose.pose.position.x, _x.goal.store_pose.pose.position.y, _x.goal.store_pose.pose.position.z, _x.goal.store_pose.pose.orientation.x, _x.goal.store_pose.pose.orientation.y, _x.goal.store_pose.pose.orientation.z, _x.goal.store_pose.pose.orientation.w,) = _get_struct_7d().unpack(str[start:end])
      return self
