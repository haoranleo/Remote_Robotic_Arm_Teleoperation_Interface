...
class Pr2GripperCommandActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new Pr2GripperCommandResult();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = Pr2GripperCommandResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Pr2GripperCommandActionResult(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [status]
    data.status = actionlib_msgs.msg.GoalStatus.deserialize(buffer, bufferOffset);
    // Deserialize message field [result]
    data.result = Pr2GripperCommandResult.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Pr2GripperCommandActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = Pr2GripperCommandResult.Resolve(msg.result)
    }
    else {
      resolved.result = new Pr2GripperCommandResult()
    }
...
module.exports = Pr2GripperCommandActionResult;
