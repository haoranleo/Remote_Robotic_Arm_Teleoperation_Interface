...
class GripperActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GripperResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GripperActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = GripperResult.Resolve(msg.result)
    }
    else {
      resolved.result = new GripperResult()
    }
...
module.exports = GripperActionResult;
