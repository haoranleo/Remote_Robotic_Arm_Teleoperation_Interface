...
(cl:defmethod cl:initialize-instance :after ((m <LoadController-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LoadController-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr2_mechanism_msgs-srv:<LoadController-request> is deprecated: use pr2_mechanism_msgs-srv:LoadController-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <LoadController-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LoadController-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr2_mechanism_msgs-srv:<LoadController-response> is deprecated: use pr2_mechanism_msgs-srv:LoadController-response instead.")))
