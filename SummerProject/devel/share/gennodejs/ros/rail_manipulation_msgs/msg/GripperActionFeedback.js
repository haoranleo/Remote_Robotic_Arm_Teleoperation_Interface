...
class GripperActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new GripperFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GripperFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GripperActionFeedback(null);
    ...
    data.feedback = GripperFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += GripperFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GripperActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = GripperFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new GripperFeedback()
    }
...
module.exports = GripperActionFeedback;
