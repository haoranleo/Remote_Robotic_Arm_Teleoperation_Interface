    ...
    try:
      ...
      for val1 in self.ik_request.robot_state.attached_collision_objects:
        ...
        for val3 in _v103.plane_poses:
          ...
          _x = _v112
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v103.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.solution.attached_collision_objects:
        ...
        _v199 = val1.object
        _v200 = _v199.header
        buff.write(_get_struct_I().pack(_v200.seq))
        _v201 = _v200.stamp
        _x = _v201
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v200.frame_id
        ...
        for val3 in _v199.plane_poses:
          ...
          _x = _v208
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v199.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
    ...
    try:
      ...
      for val1 in self.solution.attached_collision_objects:
        ...
        for val3 in _v239.plane_poses:
          ...
          _x = _v248
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v239.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
