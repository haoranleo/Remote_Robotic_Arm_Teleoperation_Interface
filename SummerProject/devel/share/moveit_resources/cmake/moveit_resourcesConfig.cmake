...
if("TRUE" STREQUAL "TRUE")
  set(moveit_resources_SOURCE_PREFIX /home/orsteam/SummerProject/src/moveit_resources)
  set(moveit_resources_DEVEL_PREFIX /home/orsteam/SummerProject/devel)
  ...
  set(moveit_resources_INSTALL_PREFIX /home/orsteam/SummerProject/install)
...
if(NOT "/home/orsteam/SummerProject/src/moveit_resources/include " STREQUAL " ")
  set(moveit_resources_INCLUDE_DIRS "")
  set(_include_dirs "/home/orsteam/SummerProject/src/moveit_resources/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_resources' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/orsteam/SummerProject/src/moveit_resources/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@willowgarage.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${moveit_resources_dep}_FOUND)
      find_package(${moveit_resources_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${moveit_resources_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
