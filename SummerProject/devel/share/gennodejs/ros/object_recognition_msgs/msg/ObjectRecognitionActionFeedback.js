...
class ObjectRecognitionActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ObjectRecognitionActionFeedback
    ...
    bufferOffset = ObjectRecognitionFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ObjectRecognitionActionFeedback
    let len;
    let data = new ObjectRecognitionActionFeedback(null);
    ...
    data.feedback = ObjectRecognitionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ObjectRecognitionActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = ObjectRecognitionFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new ObjectRecognitionFeedback()
    }
...
module.exports = ObjectRecognitionActionFeedback;
