...
(cl:in-package agile_grasp_base-msg)
...
(cl:defclass <Grasps> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (grasps
    :reader grasps
    :initarg :grasps
    :type (cl:vector agile_grasp_base-msg:Grasp)
   :initform (cl:make-array 0 :element-type 'agile_grasp_base-msg:Grasp :initial-element (cl:make-instance 'agile_grasp_base-msg:Grasp))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Grasps>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Grasps)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name agile_grasp_base-msg:<Grasps> is deprecated: use agile_grasp_base-msg:Grasps instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Grasps>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader agile_grasp_base-msg:header-val is deprecated.  Use agile_grasp_base-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'grasps-val :lambda-list '(m))
(cl:defmethod grasps-val ((m <Grasps>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader agile_grasp_base-msg:grasps-val is deprecated.  Use agile_grasp_base-msg:grasps instead.")
  (grasps m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Grasps>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'grasps)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'agile_grasp_base-msg:Grasp))
