...
"""autogenerated by genpy from pr2_mechanism_msgs/SwitchControllerAction.msg. Do not edit."""
import sys
...
class SwitchControllerAction(genpy.Message):
  _md5sum = "c7b048ee44f1abe19d1dfae77332d13a"
  _type = "pr2_mechanism_msgs/SwitchControllerAction"
...
"""
  ...
  _slot_types = ['pr2_mechanism_msgs/SwitchControllerActionGoal','pr2_mechanism_msgs/SwitchControllerActionResult','pr2_mechanism_msgs/SwitchControllerActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SwitchControllerAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = pr2_mechanism_msgs.msg.SwitchControllerActionGoal()
      if self.action_result is None:
        self.action_result = pr2_mechanism_msgs.msg.SwitchControllerActionResult()
      if self.action_feedback is None:
        self.action_feedback = pr2_mechanism_msgs.msg.SwitchControllerActionFeedback()
    else:
      self.action_goal = pr2_mechanism_msgs.msg.SwitchControllerActionGoal()
      self.action_result = pr2_mechanism_msgs.msg.SwitchControllerActionResult()
      self.action_feedback = pr2_mechanism_msgs.msg.SwitchControllerActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_goal.goal.start_controllers)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.start_controllers:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.pack('<I%ss'%length, length, val1))
      length = len(self.action_goal.goal.stop_controllers)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.stop_controllers:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.start_controllers = []
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.action_goal.goal.start_controllers.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.stop_controllers = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.action_goal.goal.stop_controllers.append(val1)
      _x = self
      start = end
      end += 12
