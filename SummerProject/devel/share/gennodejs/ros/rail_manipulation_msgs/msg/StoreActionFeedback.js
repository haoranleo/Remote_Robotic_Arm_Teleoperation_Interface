...
class StoreActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new StoreFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = StoreFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new StoreActionFeedback(null);
    ...
    data.feedback = StoreFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += StoreFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new StoreActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = StoreFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new StoreFeedback()
    }
...
module.exports = StoreActionFeedback;
